...
//        }
    ...
    public void generateTimes(int unit){
        ...
        while (remainingProcesses > 0){
            ...
            // Check whether new process arrives with less remaining time
            int minRemainingTime = (currentProcessIndex == -1) ? Integer.MAX_VALUE : processes.get(currentProcessIndex).remainingTime;
            for (int i = 0; i < size; i++) {
